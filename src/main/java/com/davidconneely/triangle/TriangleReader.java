...
/**
 * Reads triangular data from provided input. The specification isn't very
 * detailed about the text format, so some assumptions about what is allowed and
 * what is not have been made.
 * <p>
 * <b>Assumptions:</b>
 * <ul>
 * <li>Lines may have leading or trailing space characters</li>
 * <li>Values must be 32-bit signed integers only</li>
 * <li>Values can be separated by one or more space characters</li>
 * <li>Blank lines are not allowed in the input data</li>
 * </ul>
 */
public final class TriangleReader {
	...
	/**
	 * Initialize from an <code>InputStream</code> instance, using the default
	 * charset to read character data from it.
	 */
	...
	private int[] readLine() throws IOException {
		...
		for (int i = 0; i < numbers.length; ++i) {
			...
			try {
				...
				throw new TriangleValueException(rdr.getLineNumber(), i + 1,
						value);
			}
		}
		return numbers;
	 ...
	 * @throws TriangleShapeException
	 *             If a line of triangle data is too short or too long.
	 */
