...
public final class MinTrianglePath {
	/**
	 * Read a text-format triangle from standard input and output a minimal path
	 * to standard output in a specific way.
	 */
	public static void main(String[] args) {
		...
		try {
			...
			System.err.println("The sum of numbers along part of some path"
